...
My name is **Gabriel Gutierrez Pereira Soares**, and I'm a Computer Engineer
with background in Electronics and Embedded Systems, from João Pessoa, Paraíba,
Brazil.

- 🔭 I’m currently working as Technical Account Manager at Huawei Cloud Brazil
  in São Paulo, São Paulo, Brazil;
- 💬 Ask me about technical details of Huawei Cloud services, and cloud
  computing in general (Compute, Storage, Networking, Containers, Development,
  Terraform etc);
- 🤓 If you speak Portuguese, watch some training videos and materials I've
  recorded for Huawei Cloud: <https://linktr.ee/aprendahwc>
- 💡 **Career and Leadership model**
  - Several codes, solutions and corrections proposed by me since 2018 were the
    result of challenges while I was working on various teams led and managed
    by [Luana Barros][luana]. In the first two years I worked with both
    software and electronic systems. She is currently **Head of Training and**
    **Development of Huawei Cloud Brazil** and I continued on her team as a
    Cloud TAM. She is always looking for **profiles recommendation of**
    **technically skilled talents** in the Cloud Computing area, such as SAs
...
[luana]: <https://www.linkedin.com/in/luanarbarros/>
